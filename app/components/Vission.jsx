    ...
    <section className="py-8 sm:py-8 lg:py-10">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 pb-10">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="mt-6 text-3xl font-bold leading-relaxed text-black sm:text-4xl lg:text-5xl">{t("vission-title")}<span className="text-primary-600">{" "}{t("youngstar")}</span></h2>
        </div>
          ...
          <div className="space-y-8 lg:pr-16 xl:pr-24 lg:col-span-2 lg:space-y-12">
            <div className="flex items-start">
              ...
              <div className="ml-5">
                ...
                <p className="mt-3 text-xl text-gray-900">{t("mission")}</p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div className="ml-5">
                ...
                <p className="mt-3 text-xl text-gray-900">{t("vision")}</p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div className="ml-5">
                ...
                <p className="mt-3 text-xl text-gray-900">{t("slogan")}</p>
              </div>
            </div>
          </div>
